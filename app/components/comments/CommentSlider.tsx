...
export function CommentSlider({ fileId, isOpen, onClose, currentUserEmail }: CommentSliderProps) {
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            {loading ? (
              ...
              comments.map((comment) => (
                <div key={comment.id} className="bg-stripe-light rounded-lg p-4 border border-stripe-border">
